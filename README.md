...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/eduvisiontrainer/react&stack=cms)
...
- Give your zap a name, example: "Automatic deploy ReactSpace" and make sure your zap is turned on
...
- Now go to the [form settings](https://app.netlify.com/sites/relaxed-goldwasser-dee791/settings/forms#form-notifications) in you Netlify project
